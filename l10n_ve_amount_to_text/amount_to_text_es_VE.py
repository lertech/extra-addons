...
#    modified by: Francisco Lercari <flercari@lertech.com.ve>
############################################################################
#
...
class amount_to_text:
    ...
    def amount_to_text_cheque(self, nNumero, intermedio="bolivares ", sufijo="centimos "):
        """
        ...
        strCantDecimal = self.amount_to_text(intCantDecimal)
        return strCantEntera+' '+intermedio+' '" con"' '+strCantDecimal+' '+sufijo
...
def get_amount_to_text(self, amount, lang, currency=""):
    ...
    """
    if currency.upper() in ('VEF', 'VEB', 'BOLIVARES'):
        sufijo = 'CENTIMOS'
        currency = 'BOLIVARES'
    else:
        sufijo = 'CENTIMO'
...
if __name__ == "__main__":
    ...
    letra = amount_to_text().amount_to_text(0, 'cero bolivares con cero centimos') 
    letra = amount_to_text().amount_to_text(12.01, 'doce bolivares con un centimo')
    letra = amount_to_text().amount_to_text(150867.55, 'ciento cincuenta mil ochocientos sesenta y siete bolivares con cincuenta y cinco centimos')
    letra = amount_to_text().amount_to_text(8111120189675.76, 'ocho billones ciento once mil ciento veinte millones ciento ochenta y nueve mil seiscientos setenta y cinco bolivares con setenta y seis centimos')
